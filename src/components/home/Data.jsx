...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Zehra
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Bilgisayar Mühendisi</h3>

        <p className="home__description">Merhaba, ben Zehra ŞAHAPLIOĞLU. kendimi hem Front-end hem de Back-End tarafında geliştirmeye çalışan bir Bilgisayar Mühendisiyim.</p>
